...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        await message.reply_text(
            text=f"<b><i>𝚃ꫝꪖꪀ𝘬 ꪗꪮ𝘶 𝖋ꪮ𝘳 ꪖ𝘥𝘥𝘪ꪀᧁ ꪑꫀ 𝘪ꪀ {message.chat.title} ❣️\n\n𝘐ᠻ ꪗꪮ𝘶 ꫝꪖꪜꫀ ꪖꪀꪗ 𝘲𝑢ꫀ𝘴𝑡𝑖ꪮꪀ𝘴 & 𝑑ꪮ𝑢𝑏𝑡𝘴 𝑖ꪀ ꪗꪮ𝑢𝘴𝑖ꪀᧁ ꪑꫀ ᥴꪮꪀ𝑡ꪖᥴ𝑡 𝑆ꪊρρꪮ𝘳𝑡 ❕\n\n©ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙ𝚢\n.   <a href='https://t.me/peace_fighter_TG'>»»»»»»»𝙿𝚎𝙰𝚌𝙴-𝙵𝚒𝙶𝚑𝚃𝚎𝚁-𝚃𝙶</a></i></b>",
            reply_markup=reply_markup)
    else:
        for u in message.new_chat_members:
            if (temp.MELCOW).get('welcome') is not None:
                try:
                    ...
                    pass
            temp.MELCOW['welcome'] = await message.reply(f"<b><i>ꫝꫀꪗ {u.mention}🙋‍♀️, ᭙ꫀꪶᥴꪮꪑꫀ 𝘵ꪮ {message.chat.title}</i></b>")
